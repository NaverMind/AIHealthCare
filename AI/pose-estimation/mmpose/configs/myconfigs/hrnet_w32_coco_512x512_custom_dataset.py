_base_ = [
    '../_base_/default_runtime_hrnet_custom_dataset.py',
...
data_root = '/shared/home/navermind/Training_data'
...
data = dict(
    ...
    train=dict(
        ...
        ann_file=f'{data_root}/dataset/train_labels/train_coco_fitness.json',
    ...
    val=dict(
        type='BottomUpCocoDataset',
        ann_file=f'{data_root}/dataset/val_labels/val_coco_fitness.json',
        img_prefix=f'{data_root}',
        data_cfg=data_cfg,
